...
module.exports = {
    ...
    execute(message, args){
        ...
        if(randomNum == 1){
        message.channel.send(`IT'S PEGGING TIME, <@${265585060776902656}>`, l1);
        message.delete({ timeout: 1000 });

    } else if(randomNum == 2){
        message.channel.send(`THAT ASS IS MINE, <@${265585060776902656}>`, l2);
        message.delete({ timeout: 1000 });
    } else if(randomNum == 3){
            message.channel.send(`GET OVER HERE <@${265585060776902656}>, IT'S PEGGIN' TIME`, l3);
            message.delete({ timeout: 1000 });
    } else if(randomNum == 4){
        message.channel.send(`TIME FOR A PEGGING SESH, <@${265585060776902656}>!`, l4);
        message.delete({ timeout: 1000 });
}
}
};